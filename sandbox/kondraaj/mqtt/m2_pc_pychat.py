...
Authors: David Fisher and Aaron Kondrat.
...
def main():
    ...
    my_name = "Aaron"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Isaiah"  # Used to set the topic that you will *publish to*
