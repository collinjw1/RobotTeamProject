...
def main():
    ...
    forward_button['command'] = lambda: send_drive(mqtt_client, int(left_speed_entry.get()),
                                                                int(right_speed_entry.get()))
    root.bind('<Up>', lambda event: send_drive(mqtt_client, int(left_speed_entry.get()), int(right_speed_entry.get())))
    ...
    right_button['command'] = lambda: send_right(mqtt_client, int(left_speed_entry.get()))
...
def send_drive(client, left_speed, right_speed):
    ...
    client.send_message('drive', [left_speed, right_speed])
...
def send_back(client, left_speed, right_speed):
